...
export const LayerPanel: React.FC<LayerPanelProps> = ({ }) => {
  ...
  // Load layers and subscribe to changes using events
  useEffect(() => {
    const updateLayers = () => {
    ...
    // Subscribe to layer events instead of polling
      ...
      <div className="layerSearch">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff" fill="none">
            ...
            <path stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M18 15.5L13 15.5M15.5 13V18"></path>
          </svg>
        </button>
      </div>
              ...
              <div className="layerControls">
                <button className="controlButton visibility" title="Toggle Visibility">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#ffffff">
                    <path fill="none" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" d="M2 8C2 8 6.47715 3 12 3C17.5228 3 22 8 22 8"></path>
                    <path fill="none" stroke="#ffffff" strokeWidth="1.5" d="M21.544 13.045C21.848 13.4713 22 13.6845 22 14C22 14.3155 21.848 14.5287 21.544 14.955C20.1779 16.8706 16.6892 21 12 21C7.31078 21 3.8221 16.8706 2.45604 14.955C2.15201 14.5287 2 14.3155 2 14C2 13.6845 2.15201 13.4713 2.45604 13.045C3.8221 11.1294 7.31078 7 12 7C16.6892 7 20.1779 11.1294 21.544 13.045Z"></path>
                    <path fill="none" stroke="#ffffff" strokeWidth="1.5" d="M15 14C15 12.3431 13.6569 11 12 11C10.3431 11 9 12.3431 9 14C9 15.6569 10.3431 17 12 17C13.6569 17 15 15.6569 15 14Z"></path>
                  </svg>
                </button>
                <button className="controlButton lock" title="Toggle Lock">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    <path fill="none" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" d="M12 16.5V14.5"></path>
                    <path fill="none" stroke="#ffffff" strokeWidth="1.5" d="M4.2678 18.8447C4.49268 20.515 5.87612 21.8235 7.55965 21.9009C8.97626 21.966 10.4153 22 12 22C13.5847 22 15.0237 21.966 16.4403 21.9009C18.1239 21.8235 19.5073 20.515 19.7322 18.8447C19.8789 17.7547 20 16.6376 20 15.5C20 14.3624 19.8789 13.2453 19.7322 12.1553C19.5073 10.485 18.1239 9.17649 16.4403 9.09909C15.0237 9.03397 13.5847 9 12 9C10.4153 9 8.97626 9.03397 7.55965 9.09909C5.87612 9.17649 4.49268 10.485 4.2678 12.1553C4.12104 13.2453 3.99999 14.3624 3.99999 15.5C3.99999 16.6376 4.12104 17.7547 4.2678 18.8447Z"></path>
                    <path fill="none" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M7.5 9V6.5C7.5 4.01472 9.51472 2 12 2C14.4853 2 16.5 4.01472 16.5 6.5V9"></path>
                  </svg>
                </button>
